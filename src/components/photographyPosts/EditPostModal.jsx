...
const EditPostModal = ({ id, isOpen, onClose, onSubmitSuccess }) => {
  ...
  const setInitialData = async () => {
    try {
      ...
      const [postData, mediaFilesData] = await Promise.all([
        PhotographyPostApi.getPostById(id),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update the post
      await PhotographyPostApi.updatePost(id, postData);
  ...
  return (
    <Modal
      ...
      style={customStyles}
      contentLabel="Edit Photography Post"
    >
      <div className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-t-lg p-5">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-bold text-white">Edit Photography Post</h2>
          <button
